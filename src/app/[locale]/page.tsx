  ...
  return <>
    <section className="home-hero" aria-labelledby="hero-title">
      <div className="container hero-layout">
        ...
        <div className="hero-visual hero-visual-enter"><span className="hero-architecture" aria-hidden="true" /><div className="hero-image" style={{ backgroundImage: `url(${heroImage})` }} role="img" aria-label={ar ? "رعاية طبية في بيت الطب" : "Personal medical care at Beit El Teb"} /><div className="hero-float"><span className="pulse-dot" /><div><strong>{ar ? "مواعيد في نفس اليوم" : "Same-day appointments"}</strong><small>{ar ? "عندما تحتاج إلى الرعاية" : "Care, when you need it"}</small></div></div></div>
      </div>
    </section>
